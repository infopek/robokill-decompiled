package ObjectConstructors
{
   ...
   {
      public static var collision_12:GameObjectCollision;
      
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.boss_head_png;
      
      public static var baseim:BitmapData = new Embeds.boss_head_png().bitmapData;
      
      public function Boss_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 4;
         var _loc6_:GameObjectCollision = collision_12;
         if(!_loc6_)
         {

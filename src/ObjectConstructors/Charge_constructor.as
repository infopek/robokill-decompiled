package ObjectConstructors
{
   ...
   public class Charge_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.charge_shield001_png;
      
      public static var baseim:BitmapData = new Embeds.charge_shield001_png().bitmapData;
      ...
      public function Charge_constructor()
      {
         super();
      }

package ObjectConstructors
{
   ...
   public class EnemyHealthBar_constructor
   {
      public static var LayerName:String = "TextLayer";
      
      public static var baseim_embed:Class = Embeds.health_backing_png;
      
      public static var baseim:BitmapData = new Embeds.health_backing_png().bitmapData;
      
      public static var child1_embed:Class = Embeds.health_overlay_png;
      
      public static var child1:BitmapData = new Embeds.health_overlay_png().bitmapData;
      
      public function EnemyHealthBar_constructor()
      {
         super();
      }

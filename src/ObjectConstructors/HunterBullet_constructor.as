package ObjectConstructors
{
   ...
   public class HunterBullet_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.hunter_bullet_png;
      
      public static var baseim:BitmapData = new Embeds.hunter_bullet_png().bitmapData;
      
      public function HunterBullet_constructor()
      {
         super();
      }

package ObjectConstructors
{
   ...
   public class Spawn_constructor
   {
      public static var LayerName:String = "Floor";
      
      public static var baseim_embed:Class = Embeds.spawn_png;
      
      public static var baseim:BitmapData = new Embeds.spawn_png().bitmapData;
      
      public function Spawn_constructor()
      {
         super();
      }

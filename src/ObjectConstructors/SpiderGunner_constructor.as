package ObjectConstructors
{
   ...
   public class SpiderGunner_constructor
   {
      public static var collision_4:GameObjectCollision;
      
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.spidergunner_png;
      
      public static var baseim:BitmapData = new Embeds.spidergunner_png().bitmapData;
      
      public function SpiderGunner_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 0;
         var _loc6_:GameObjectCollision = collision_4;
         if(!_loc6_)
         {

package ObjectConstructors
{
   ...
   public class DoorMask_constructor
   {
      public static var LayerName:String = "AbovePlayer";
      
      public static var baseim_embed:Class = Embeds.doormask_png;
      
      public static var baseim:BitmapData = new Embeds.doormask_png().bitmapData;
      
      public function DoorMask_constructor()
      {
         super();
      }

package ObjectConstructors
{
   ...
   public class ControlHelp_constructor
   {
      public static var LayerName:String = "TextLayer";
      
      public static var baseim_embed:Class = Embeds.control_png;
      
      public static var baseim:BitmapData = new Embeds.control_png().bitmapData;
      
      public function ControlHelp_constructor()
      {
         super();
      }

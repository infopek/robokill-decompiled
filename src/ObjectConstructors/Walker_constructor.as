package ObjectConstructors
{
   ...
   public class Walker_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.walker_png;
      
      public static var baseim:BitmapData = new Embeds.walker_png().bitmapData;
      
      public function Walker_constructor()
      {
         super();
      }

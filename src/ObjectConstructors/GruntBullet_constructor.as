package ObjectConstructors
{
   ...
   public class GruntBullet_constructor
   {
      public static var LayerName:String = "BelowPlayer";
      
      public static var baseim_embed:Class = Embeds.gruntbullet_png;
      
      public static var baseim:BitmapData = new Embeds.gruntbullet_png().bitmapData;
      
      public function GruntBullet_constructor()
      {
         super();
      }

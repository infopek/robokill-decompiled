package ObjectConstructors
{
   ...
   public class Grunt_constructor
   {
      public static var collision_1:GameObjectCollision;
      
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.grunt_head_png;
      
      public static var baseim:BitmapData = new Embeds.grunt_head_png().bitmapData;
      
      public function Grunt_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 4;
         var _loc6_:GameObjectCollision = collision_1;
         if(!_loc6_)
         {

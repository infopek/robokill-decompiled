package ObjectConstructors
{
   ...
   public class BigTurret_constructor
   {
      public static var LayerName:String = "BelowPlayer";
      
      public static var baseim_embed:Class = Embeds.turrettop_2_png;
      
      public static var baseim:BitmapData = new Embeds.turrettop_2_png().bitmapData;
      
      public function BigTurret_constructor()
      {
         super();
      }

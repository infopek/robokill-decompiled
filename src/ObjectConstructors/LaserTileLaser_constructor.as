package ObjectConstructors
{
   ...
   public class LaserTileLaser_constructor
   {
      public static var LayerName:String = "AbovePlayer";
      
      public static var baseim_embed:Class = Embeds.enemylaser_png;
      
      public static var baseim:BitmapData = new Embeds.enemylaser_png().bitmapData;
      
      public function LaserTileLaser_constructor()
      {
         super();
      }

package ObjectConstructors
{
   ...
   public class SpiderSpit_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.spider_spit_png;
      
      public static var baseim:BitmapData = new Embeds.spider_spit_png().bitmapData;
      
      public function SpiderSpit_constructor()
      {
         super();
      }

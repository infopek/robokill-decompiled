package ObjectConstructors
{
   ...
   public class DroidBullet_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.droidshot_png;
      
      public static var baseim:BitmapData = new Embeds.droidshot_png().bitmapData;
      
      public function DroidBullet_constructor()
      {
         super();
      }

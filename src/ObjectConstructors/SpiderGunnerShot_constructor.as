package ObjectConstructors
{
   ...
   public class SpiderGunnerShot_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.spidergunnershot_png;
      
      public static var baseim:BitmapData = new Embeds.spidergunnershot_png().bitmapData;
      
      public function SpiderGunnerShot_constructor()
      {
         super();
      }

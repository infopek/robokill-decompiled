package ObjectConstructors
{
   ...
   public class FlameThrowerTile_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.flamethrowertile_png;
      
      public static var baseim:BitmapData = new Embeds.flamethrowertile_png().bitmapData;
      
      public static var child1_embed:Class = Embeds.gun_flash_2_png;
      
      public static var child1:BitmapData = new Embeds.gun_flash_2_png().bitmapData;
      ...
      public function FlameThrowerTile_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 0;
         _loc6_ = new GameObject(param1,child1_embed,"Player",0,16);
         _loc6_.name = "";
         ...
         GameObjectFilterPulse(_loc7_).Speed = 2.5;
         param2.addChild(_loc6_);
         _loc6_ = new GameObject(param1,child2_embed,"Player",0,16);
         _loc6_.name = "";
         _loc6_.baseHandleX = 0.5;
         _loc6_.baseHandleY = 0.5;
         _loc6_.basex = 0;

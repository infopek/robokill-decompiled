package ObjectConstructors
{
   ...
   public class BigFlyBot_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.flybot_2_png;
      
      public static var baseim:BitmapData = new Embeds.flybot_2_png().bitmapData;
      
      public function BigFlyBot_constructor()
      {
         super();
      }

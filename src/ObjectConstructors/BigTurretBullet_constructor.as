package ObjectConstructors
{
   ...
   public class BigTurretBullet_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.big_turret_bullet_png;
      
      public static var baseim:BitmapData = new Embeds.big_turret_bullet_png().bitmapData;
      
      public function BigTurretBullet_constructor()
      {
         super();
      }

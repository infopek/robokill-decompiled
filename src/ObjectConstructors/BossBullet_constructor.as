package ObjectConstructors
{
   ...
   public class BossBullet_constructor
   {
      public static var collision_16:GameObjectCollision;
      
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.boss_bullet_png;
      
      public static var baseim:BitmapData = new Embeds.boss_bullet_png().bitmapData;
      
      public function BossBullet_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 0;
         var _loc6_:GameObjectCollision = collision_16;
         if(!_loc6_)
         {

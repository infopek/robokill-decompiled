package ObjectConstructors
{
   ...
   public class CommWindow_constructor
   {
      public static var LayerName:String = "AfterTextLayer";
      
      public static var baseim_embed:Class = Embeds.shop_character_png;
      
      public static var baseim:BitmapData = new Embeds.shop_character_png().bitmapData;
      
      public function CommWindow_constructor()
      {
         super();
      }

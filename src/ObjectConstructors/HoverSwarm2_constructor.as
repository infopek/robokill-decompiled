package ObjectConstructors
{
   ...
   public class HoverSwarm2_constructor
   {
      public static var collision_10:GameObjectCollision;
      
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.hoverswarm2_png;
      
      public static var baseim:BitmapData = new Embeds.hoverswarm2_png().bitmapData;
      
      public function HoverSwarm2_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 0;
         var _loc6_:GameObjectCollision = collision_10;
         if(!_loc6_)
         {

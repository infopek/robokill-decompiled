package ObjectConstructors
{
   ...
   public class ShootingGrunt_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.grunt_head_2_png;
      
      public static var baseim:BitmapData = new Embeds.grunt_head_2_png().bitmapData;
      
      public function ShootingGrunt_constructor()
      {
         super();
      }

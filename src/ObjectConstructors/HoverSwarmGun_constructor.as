package ObjectConstructors
{
   ...
   public class HoverSwarmGun_constructor
   {
      public static var collision_9:GameObjectCollision;
      
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.hoverswarm_gun_png;
      
      public static var baseim:BitmapData = new Embeds.hoverswarm_gun_png().bitmapData;
      
      public function HoverSwarmGun_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 0;
         var _loc6_:GameObjectCollision = collision_9;
         if(!_loc6_)
         {

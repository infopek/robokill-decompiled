package ObjectConstructors
{
   ...
   public class LaserTile_constructor
   {
      public static var LayerName:String = "Player";
      
      public static var baseim_embed:Class = Embeds.lazer_machine_png;
      
      public static var baseim:BitmapData = new Embeds.lazer_machine_png().bitmapData;
      ...
      public function LaserTile_constructor()
      {
         super();
      }
      ...
      public static function setup(param1:GameScene, param2:GameObject) : void
      {
         ...
         param2.animSpeed = 0;
         _loc6_ = new GameObject(param1,child1_embed,"Player",0,15);
         _loc6_.name = "";
         ...
         _loc6_ = new GameObject(param1,child2_embed,"Player",0,19);
         _loc6_.name = "";
         _loc6_.baseHandleX = 0.5;
         _loc6_.baseHandleY = 0.5;
         _loc6_.basex = 0;

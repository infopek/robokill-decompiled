...
class ModuleInfoProxy extends EventDispatcher implements IModuleInfo
{
   ...
   public function load(param1:ApplicationDomain = null, param2:SecurityDomain = null) : void
   {
      var _loc3_:ModuleEvent = null;
      info.resurrect();
      if(!referenced)
      {
         info.addReference();
      ...
      else if(info.loaded)
      {
         if(info.setup)
         {
            ...
            if(info.ready)
            {
               _loc3_ = new ModuleEvent(ModuleEvent.PROGRESS);
               _loc3_.bytesLoaded = info.size;
               _loc3_.bytesTotal = info.size;
...
class ModuleInfo extends EventDispatcher
{
   ...
   {
      return !limbo && Boolean(factoryInfo) ? int(factoryInfo.bytesTotal) : 0;
   }
   ...
   public function load(param1:ApplicationDomain = null, param2:SecurityDomain = null) : void
   {
      ...
      _loc4_.applicationDomain = !!param1 ? param1 : new ApplicationDomain(ApplicationDomain.currentDomain);
      _loc4_.securityDomain = param2;
